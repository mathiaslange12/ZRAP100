CLASS zcl_rap100_gen_data_3285 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_3285 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '3285',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap_atrav3285.
*    DELETE FROM zrap100_dtravsol.

    "insert travel demo data
    INSERT zrap_atrav3285  FROM (
        SELECT
